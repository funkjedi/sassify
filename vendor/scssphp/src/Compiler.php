 ...
 * In summary:
 *
 * The `Compiler` class Leafo_ScssPhp_creates an instance of the parser, feeds it SCSS code,
 * then transforms the resulting tree to a CSS tree. This class Leafo_ScssPhp_also holds the
 * evaluation context, such as all available mixins and variables at any given
 * time.
 *
 * The `Parser` class Leafo_ScssPhp_is only concerned with parsing its input.
 *
...
class Leafo_ScssPhp_Compiler
{
    ...
    protected $formatter = 'Leafo_ScssPhp_Formatter_Nested';
    ...
    public function compile($code, $name = null)
    {
        ...
        $this->parser = new Leafo_ScssPhp_Parser($name);
    ...
    {
        $this->sourcePos = isset($child[Leafo_ScssPhp_Parser::SOURCE_POSITION]) ? $child[Leafo_ScssPhp_Parser::SOURCE_POSITION] : -1;
        $this->sourceParser = isset($child[Leafo_ScssPhp_Parser::SOURCE_PARSER]) ? $child[Leafo_ScssPhp_Parser::SOURCE_PARSER] : $this->parser;
    ...
    protected function injectVariables(array $args)
    {
        ...
        $parser = new Leafo_ScssPhp_Parser(__METHOD__, false);
